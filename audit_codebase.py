...
class CodebaseAuditor:
    ...
    def __init__(self, root_dir: str):
        ...
        self.patterns = {
            'todo': {
                ...
                'exclude_patterns': [r'audit_codebase\.py$', r'fix_hardcoded_values\.py$']  # Skip audit tools
            },
            'mock_non_test': {
                ...
                'exclude_patterns': [
                    ...
                    r'mock_.*\.py$', r'audit_codebase\.py$', r'.*example.*\.py$'
                ]
            },
            'placeholder': {
            ...
            'print_debug': {
                ...
                'exclude_patterns': [r'debug_.*\.py$', r'test_.*\.py$']  # Skip debug scripts and tests
            }
        }
    ...
    def search_pattern_in_file(self, file_path: Path, pattern_name: str) -> List[AuditResult]:
...
def main():
    ...
    parser.add_argument('--max-per-category', '-m', type=int, default=10,
