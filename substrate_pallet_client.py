...
class SubstratePalletClient:
    ...
    def connect(self) -> bool:
        ...
        try:
            ...
            if not connection_successful:
                print(f"❌ Failed to connect to Substrate chain on all attempted URLs")
                return False
    ...
    def register_module(self, public_key: str, cid: str) -> ModuleRegistration:
        ...
        print(f"📝 Registering module on-chain...")
        ...
        try:
            ...
            print(f"🔧 Composed extrinsic call: ModuleRegistry::register_module")
            ...
            print(f"📡 Extrinsic submitted to chain")
            ...
            if is_success:
                ...
                for event in receipt.triggered_events:
                    ...
                    if event.module_id == 'ModuleRegistry' and event.event_id == 'ModuleRegistered':
                        print(f"   ✅ ModuleRegistered event found!")
                        print(f"   📋 Event attributes: {event.attributes}")
                        registration.events = receipt.triggered_events
                        break
                else:
                    print(f"🎉 Extrinsic submitted - check blockchain for ModuleRegistered event")
            else:
                print(f"❌ Module registration failed")
                if isinstance(receipt, dict):
    ...
    def get_module_by_key(self, public_key: str) -> Optional[str]:
        """
        ...
        try:
            ...
            if result.value is not None:
                ...
                print(f"❌ Module not found on-chain")
                return None
    ...
    def update_module(self, public_key: str, new_cid: str) -> ModuleRegistration:
        ...
        print(f"🔄 Updating module on-chain...")
        print(f"   Public Key: {public_key}")
        ...
        try:
            ...
            print(f"📡 Update extrinsic submitted")
            ...
            if is_success:
                print(f"✅ Module update successful!")
                ...
                if hasattr(receipt, 'triggered_events') and receipt.triggered_events:
                    ...
                    print(f"🎉 Extrinsic submitted - check blockchain for ModuleUpdated event")
    ...
    def remove_module(self, public_key: str) -> ModuleRegistration:
        ...
        print(f"🗑️ Removing module from chain...")
        print(f"   Public Key: {public_key}")
        ...
        try:
            ...
            print(f"📡 Remove extrinsic submitted")
            ...
            if is_success:
                print(f"✅ Module removal successful!")
    ...
    def list_all_modules(self) -> List[Dict[str, str]]:
        ...
        try:
            print(f"📋 Querying all registered modules...")
...
async def test_real_pallet_integration():
    ...
    try:
        ...
        if removed_cid is None:
            print(f"✅ Removal verification successful: module not found")
        else:
